...
const ViewCredit = () => {
  ...
  const getCreditCard1 = async () => {
    try {
      const response = await fetch("https://mmjbank.herokuapp.com/creditcard1");
  ...
  const getCreditCard2 = async () => {
    try {
      const response = await fetch("https://mmjbank.herokuapp.com/creditcard2");
      const jsonData = await response.json();
  ...
  const decrementCreditCard1 = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://mmjbank.herokuapp.com/creditcardsubtract/${creditCard1[0]?.credit_card_id}`,
        {
          method: "PUT",
  ...
  const decrementCreditCard2 = async (e) => {
    ...
    try {
      ...
      const body = { balance };
      const response = await fetch(
        `https://mmjbank.herokuapp.com/creditcardsubtract/${creditCard2[0]?.credit_card_id}`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(body),
            ...
            <div class=" card_back">
              <div class="container_card">
                ...
                <div class="card-body">
                  ...
                  <button
                    className="y"
                    onClick={(e) => decrementCreditCard1(e)}
                  >
                    {" "}
                    Pay Now
                  </button>
            ...
            <div class="card_back">
              <div class="container_card">
                ...
                <div class="card-body">
                  ...
                  <button
                    className="y"
                    onClick={(e) => decrementCreditCard2(e)}
                  >
                    {" "}
                    Pay Now
                  </button>
